            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(desc) && postImageUri != null){
                  ...
                  //  filePath.putFile(postImageUri)
                    ...
                    final Task<Uri> urlTask = filePath.putFile(postImageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        @Override
                            ...
                            if (task.isSuccessful()) {
                               ...
                               final UploadTask uploadTask = storageReference.child("post_images/thumbs").child(randomName + ".jpg").putBytes(thumbData);
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        String downloadThumbUri = downloadUri;
